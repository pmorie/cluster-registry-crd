...
var clustersResource = schema.GroupVersionResource{Group: "clusterregistry", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "clusterregistry", Version: "v1alpha1", Kind: "Cluster"}
