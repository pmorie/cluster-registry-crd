...
import (
	...
	clusterregistry_v1alpha1 "github.com/pmorie/cluster-registry-crd/pkg/apis/clusterregistry/v1alpha1"
	versioned "github.com/pmorie/cluster-registry-crd/pkg/client/clientset/versioned"
	internalinterfaces "github.com/pmorie/cluster-registry-crd/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/pmorie/cluster-registry-crd/pkg/client/listers/clusterregistry/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusterregistryV1alpha1().Clusters().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusterregistryV1alpha1().Clusters().Watch(options)
			},
		},
